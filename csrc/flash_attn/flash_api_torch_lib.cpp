...
TORCH_LIBRARY_EXPAND(TORCH_EXTENSION_NAME, ops) {
    ops.def("varlen_fwd(Tensor! q, Tensor k, Tensor v, Tensor!? out, Tensor cu_seqlens_q, "
            ...
            "Tensor? actual_chunked_seqlen_k, Tensor? chunk_rotray_offset_positions, Tensor? cu_num_chunks_k, Tensor? cos_sin_cache, "
            "Tensor? block_table_offsets, bool enable_splitkv_for_chunked_kv, Tensor? alibi_slopes, "
