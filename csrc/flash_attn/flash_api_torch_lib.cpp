...
TORCH_LIBRARY_EXPAND(TORCH_EXTENSION_NAME, ops) {
    ops.def("varlen_fwd(Tensor! q, Tensor k, Tensor v, Tensor? k_descale_, Tensor? v_descale_, Tensor!? out, Tensor cu_seqlens_q, "
    ...
    ops.def("fwd_kvcache(Tensor! q, Tensor kcache, Tensor vcache, Tensor? k_descale_, Tensor? v_descale_, Tensor? k, Tensor? v, Tensor? seqlens_k, "
            "Tensor? rotary_cos, Tensor? rotary_sin, Tensor? cache_batch_idx, Tensor? leftpad_k, Tensor? block_table, "
            "Tensor? page_compress_cache, Tensor? page_compress_cache_ids, Tensor? num_compressed_pages, "
